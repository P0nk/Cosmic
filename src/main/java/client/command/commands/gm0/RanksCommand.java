...
public class RanksCommand extends Command {
    ...
    public void execute(Client c, String[] params) {
        ...
        // Debugging output
        System.out.println("World Ranking Size: " + worldRanking.size());
        for (int i = 0; i < worldRanking.size(); i++) {
            System.out.println("Rank " + (i + 1) + ": " + worldRanking.get(i).getLeft() + ", Score: " + worldRanking.get(i).getRight());
        }
