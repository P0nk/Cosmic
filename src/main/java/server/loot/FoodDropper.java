...
public final class FoodDropper {
    ...
    static {
        ...
        TIER_ITEMS.put(Tier.T3, new int[] { 4036178
                , 4036179, 4036180, 4036181, 4036182, 4036183
        });

        TIER_ITEMS.put(Tier.T4, new int[] { 4036184
                , 4036185, 4036186, 4036187, 4036188, 4036189
        });

        TIER_ITEMS.put(Tier.T5, new int[] { 4036190
                , 4036191, 4036192, 4036193, 4036194, 4036195, 4036196, 4036197, 4036198, 4036199, 4036200
        });

        TIER_ITEMS.put(Tier.T6, new int[] { 4036201
                , 4036202, 4036203, 4036204, 4036205, 4036206, 4036207, 4036208, 4036209, 4036210
        });

        TIER_ITEMS.put(Tier.T7, new int[] { 4036211
                , 4036212, 4036213, 4036214, 4036215, 4036216, 4036217, 4036218, 4036219, 4036220, 4036221, 4036222,
                4036223, 4036224, 4036225
        });

        TIER_ITEMS.put(Tier.T8, new int[] { 4036226
                , 4036227, 4036228, 4036229, 4036230, 4036231, 4036232, 4036233, 4036234, 4036235, 4036236, 4036237,
                4036238, 4036239, 4036240
        });

        TIER_ITEMS.put(Tier.T9, new int[] { 4036241
                , 4036242, 4036243, 4036244, 4036245, 4036246, 4036247, 4036248, 4036249, 4036250, 4036251, 4036252,
        ...
        TIER_ITEMS.put(Tier.T10, new int[] { 4036267
                , 4036268, 4036269, 4036270, 4036271, 4036272, 4036273, 4036274, 4036275, 4036276, 4036277, 4036278,
        ...
        TIER_ITEMS.put(Tier.LEGENDARY, new int[] { 4036289
                , 4036290, 4036291, 4036292, 4036293, 4036294, 4036295, 4036296, 4036297, 4036298, 4036299, 4036300,
