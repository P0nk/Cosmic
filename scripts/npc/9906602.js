...
var expedName = "Lucid Hard";
var expedBoss = "Lucid";
var expedMap = "Lucid's Nightmare";

var list = "What would you like to do?#b\r\n\r\n#L1#View current Expedition members#l\r\n#L2#Start the fight!#l\r\n#L3#Stop the expedition.#l";

function start() {
    if (cm.isQuestCompleted(31165)) {
        action(1, 0, 0);
    } else {
        cm.sendOk("You must have the #rArcane Path#k questline completed to gain access to this battle.");
        cm.dispose();
        return;
    }
}
...
function action(mode, type, selection) {
    ...
    em = cm.getEventManager("LucidBattle");
