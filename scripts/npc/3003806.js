...
var exped = ExpeditionType.NDARKNELL;
var expedName = "Darknell (Normal Mode)";
var expedBoss = "Darknell";
var expedMap = "Final Horizon (Normal)";

var list = "What would you like to do?#b\r\n\r\n#L1#View current Expedition members#l\r\n#L2#Start the fight!#l\r\n#L3#Stop the expedition.#l";

function start() {
    if (cm.isQuestCompleted(31163)) {
        action(1, 0, 0);
    } else {
        cm.sendOk("You must have #rThe Arcane Path Part 3#k questline completed to gain access to this battle.");
        cm.dispose();
        return;
    }
}
...
function action(mode, type, selection) {
    ...
    em = cm.getEventManager("NDarknellBattle");
