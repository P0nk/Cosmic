...
var exped = ExpeditionType.NVERUS;
var expedName = "Verus Hilla (Normal Mode)";
var expedBoss = "Verus Hilla";
var expedMap = "Altar of Desire (Normal)";

var list = "What would you like to do?#b\r\n\r\n#L1#View current Expedition members#l\r\n#L2#Start the fight!#l\r\n#L3#Stop the expedition.#l";

function start() {
    if (cm.isQuestCompleted(31164)) {
        action(1, 0, 0);
    } else {
        cm.sendOk("You must have #rThe Arcane Path Part 4#k questline completed to gain access to this battle.");
        cm.dispose();
        return;
    }
}
...
function action(mode, type, selection) {
    ...
    em = cm.getEventManager("NVerusBattle");
