...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (status == 0) {
            ...
            var msg = "Welcome to Ludibrium, where time stands still but our trains always run on schedule! I sell tickets for the train ride to Orbis.\r\n";
            msg += "\r\nThe train to Orbis departs 4 times an hour. The next available boardings are #b#e" + schedules[0] + "#k#n, #b#e" + schedules[1] + "#k#n, and #b#e" + schedules[2] + "#k#n.\r\n";
