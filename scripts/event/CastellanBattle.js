...
function setup(level, lobbyid) {
    var eim = em.newInstance("Castellan" + lobbyid);
    ...
    var mob = LifeFactory.getMonster(9400408);
    eim.getInstanceMap(800040410).spawnMonsterOnGroundBelow(mob, new Point(466, 142));
...
function clearPQ(eim) {
    eim.stopEventTimer();
    eim.setEventCleared(ExpeditionType.CASTELLAN);
}

function isCastellan(mob) {
    var mobid = mob.getId();
    return mobid == 9400409;
}
