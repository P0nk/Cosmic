/*
    Vs Verus Hilla Battle (Refactored & Fixed)
*/
...
var exitMap = 450011500;
var recruitMap = 450011500;
var clearMap = 450011500;
...
function setup(level, lobbyid) {
    var eim = em.newInstance("Verus Hilla" + lobbyid);
    eim.setProperty("level", level);
    eim.setProperty("boss", "0");
    eim.getInstanceMap(450010100).resetPQ(level);
