...
function setEventRewards(eim) {
    eim.setEventRewards(3,
        [1302080, 1002033, 2022153, 2022042, 2020006, 2020009, 2020016, 2020024, 4010006, 4010007, 4020004, 4020005, 4003002],
        [1, 1, 1, 5, 20, 15, 10, 10, 2, 4, 4, 4, 1]
    );

    eim.setEventRewards(2,
        [1302080, 1002033, 2012005, 2012006, 2020002, 2020025, 2020026, 4010003, 4010004, 4010005, 4020002, 4020003, 4020007],
        [1, 1, 15, 15, 15, 10, 10, 3, 3, 3, 3, 3, 3]
    );

    eim.setEventRewards(1,
        [1002033, 2012005, 2012006, 2020002, 2022006, 2022002, 4010000, 4010001, 4010002, 4020000, 4020001, 4020006],
        [1, 15, 15, 10, 5, 5, 2, 2, 2, 2, 2, 2]
    );
