...
var spawnTimes = [120000, 240000, 360000]; // Times to spawn mobs (in milliseconds)
var mobsToSpawn = [9990076, 9990077, 9990078]; // Mob IDs to spawn

function setup(level, lobbyid) {
    var eim = em.newInstance("Hard Darknell" + lobbyid);
    ...
    eim.schedule("spawnMob2", spawnTimes[1]);
    eim.schedule("spawnMob3", spawnTimes[2]);
...
function spawnMob1(eim) {
    ...
    var spawnX = -386; // Example position, adjust as needed
    var spawnY = 29;
    map.spawnMonsterOnGroundBelow(em.getMonster(mobsToSpawn[0]), new java.awt.Point(spawnX, spawnY));
}

function spawnMob2(eim) {
    var map = eim.getMapInstance(entryMap); // Replace entryMap with the map you are working with
    var spawnX = -386; // Example position, adjust as needed
    var spawnY = 29;
    map.spawnMonsterOnGroundBelow(em.getMonster(mobsToSpawn[1]), new java.awt.Point(spawnX, spawnY));
}

function spawnMob3(eim) {
    var map = eim.getMapInstance(entryMap); // Replace entryMap with the map you are working with
    var spawnX = -386; // Example position, adjust as needed
    var spawnY = 29;
    map.spawnMonsterOnGroundBelow(em.getMonster(mobsToSpawn[2]), new java.awt.Point(spawnX, spawnY));
}
