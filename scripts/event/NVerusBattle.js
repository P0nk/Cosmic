...
var mobsToSpawn = [9990415]; // Mob IDs to spawn

function setup(level, lobbyid) {
    var eim = em.newInstance("Normal Verus Hilla" + lobbyid);
...
function spawnMob1(eim) {
    ...
    var spawnX = 16; // Example position, adjust as needed
    var spawnY = 266;
...
function clearPQ(eim) {
    eim.stopEventTimer();
    eim.setEventCleared(ExpeditionType.NVERUS);
}

function isVerus(mob) {
    var mobid = mob.getId();
    return mobid == 9990415;
}
