/*
    Vs Cygnus Battle (Refactored & Fixed)
*/
...
function setup(level, lobbyid) {
    var eim = em.newInstance("Cygnus" + lobbyid);
...
function afterSetup(eim) {
    ...
    mapObj.spawnMonsterOnGroundBelow(LifeFactory.getMonster(8850011), new java.awt.Point(-156,24));
}
...
function clearPQ(eim) {
    eim.stopEventTimer();
    eim.setEventCleared(ExpeditionType.CYGNUS);
}

function isCygnus(mob) {
    return mob.getId() == 8850012;
}
